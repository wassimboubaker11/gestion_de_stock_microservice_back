...
import com.GestionDeStock.stock.Services.GestionaireService;
...
public class GestionaireController {
    ...
    @Autowired
    private GestionaireService gestionaireService;
    ...
    public GestionaireDTO validegestionaire (@PathVariable ("idg") int idg , @RequestBody Gestionaire gestionaire)throws MessagingException, jakarta.mail.MessagingException, IOException{
